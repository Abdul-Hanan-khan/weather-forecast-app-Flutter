...
import 'dart:convert';
import 'dart:async';
import 'utill/utills.dart' as util;
  ...
  Future _goToNextScreen(BuildContext context) async {
    ...
    if ( results != null && results.containsKey('enter')) {
     ...
     // debugPrint("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!From First screen :" + results['enter'].toString());
      debugPrint("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!From First screen :" + _cityEntered);
...
//
//
//   Kalimatic({this.enteredCity});
//
//   @override
//   _KalimaticState createState() => _KalimaticState();
// }
//
// class _KalimaticState extends State<Kalimatic> {
//
//
//   @override
//   void initState() {
...
//             alignment: Alignment.topRight,
//             child: new Text(
//               widget.enteredCity.isEmpty == null? "No Data" : widget.enteredCity,
//               style: TextStyle(
//                   color: Colors.white,
//                   fontSize: 22.9,
...
//   }
//
//   Future<Map> getWeather(String appId, String enteredCity) async {
//     String apiUrl =
//         'http://api.openweathermap.org/data/2.5/weather?q=$enteredCity&appid=$appId&units=imperial';
//     http.Response response = await http.get(apiUrl);
//     return json.decode(response.body);
//   }
//
